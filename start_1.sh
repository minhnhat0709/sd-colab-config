...
git clone --depth 1 --branch mannual-scale-engine https://github.com/minhnhat0709/eliai-engine-sd-webui-ext extensions/eliai-engine-sd-webui-ext
cd extensions/eliai-engine-sd-webui-ext
git checkout mannual-scale-engine
cd ../..
